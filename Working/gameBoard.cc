...
GameBoard::GameBoard(Player *players, Owner *admin, BoardDiaply *display, int numPlayers, rollUpRim *cups): 
    players(players), admin(admin), display(display),numPlayer(numPlayer),cups(cups) 
{
    for (int i=0; i<40; i++) {
